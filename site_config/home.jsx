    ...
    users: {
      title: '谁在使用Dubbo',
        desc: <span>请在 <a rel="noopener noreferrer" target="_blank"
                          href="https://github.com/apache/incubator-dubbo/issues/1012">Wanted: who&#39;s using dubbo</a> 上提供信息来帮助Dubbo做的更好。</span>,
      list: [
    ...
    users: {
      title: 'Who is using Dubbo',
        desc: <span>Providing your info on <a rel="noopener noreferrer" target="_blank"
                                              href="https://github.com/apache/incubator-dubbo/issues/1012">Wanted: who&#39;s using dubbo</a> to help improving dubbo better</span>,
      list: [
          '/img/users_alibaba.png',
          '/img/users_kingdee.png',
          '/img/users_dangdang.png',
