...
weight: 20
---
Dubbo 通过提供面向开发开发侧的编程框架和一系列服务治理套件，极大的简化了微服务构建的复杂度。
* 从开发层面，Dubbo 在与各个语言流行的开发框架整合的基础上提供了一套微服务开发、配置范式，并提供配套脚手架用于快速搭建微服务项目骨架。
* 从部署上来说，Dubbo 应用可以打包部署，Dubbo 提供了多种。
* Dubbo 服务治理是真正从解决微服务生产实践问题的角度出发，提供了除服务发现等能力之外的高阶特性。
